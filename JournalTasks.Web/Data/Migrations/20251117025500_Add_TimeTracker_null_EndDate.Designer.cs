...
namespace JournalTasks.Web.Migrations
{
    ...
    [Migration("20251117025500_Add_TimeTracker_null_EndDate")]
    partial class Add_TimeTracker_null_EndDate
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JournalTasks.Web.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("JournalTasks.Web.Data.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
